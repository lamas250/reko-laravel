                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            <li class="menu-title">Menu de navegação</li>
                              <li>
                                  <a href="index" class="waves-effect">
                                      <i class="ti-home"></i> <span> Página Inicial </span>
                                  </a>
                              </li>
                              <li>
                                <a href="{{route('projetos.index')}}" class="waves-effect"><i class="ti-list"></i><span>Meus Projetos </span></a>
                              </li>
                              <li>
                                  <a href="calendar" class="waves-effect"><i class="ti-calendar"></i><span>Calendário </span></a>
                              </li>
                              <li>
                                <a href="calendar" class="waves-effect"><i class="ti-user"></i><span>Equipe Técnica </span></a>
                              </li>
